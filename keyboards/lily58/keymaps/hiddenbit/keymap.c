...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_RSFT,  KC_Z,    KC_X,     KC_C,     KC_V,     KC_B,  MY_L_ROT,  KC_MPLY,  KC_N,     KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,  KC_RSFT,
              KC_LCTL, KC_LALT,  KC_LGUI,  KC_SPC,   KC_ENT,    LT(_NAVIGATION, KC_SPC),   TO_SPC,   TO_MCR
    ),
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     DM_PLY1, KC_LEFT,       KC_DOWN,       KC_RIGHT,       XXXXXXX, XXXXXXX,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  _______, _______,  DM_PLY2, LSFT(KC_LEFT), LSFT(KC_DOWN), LSFT(KC_RIGHT), XXXXXXX, _______,
                               _______, _______, _______,  _______, _______,  _______,       _______,   _______
    ),

    [_SPECIAL_CHARS] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX,  XXXXXXX,       XXXXXXX,       XXXXXXX,      XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX,  LSFT(KC_9),    LSFT(KC_0),    LSFT(KC_EQL), KC_RBRC,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX,  KC_LBRC,       KC_RBRC,       KC_EQL,       KC_BSLS,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  _______, RGB_TOG,  XXXXXXX, XXXXXXX,  LSFT(KC_LBRC), LSFT(KC_RBRC), XXXXXXX,      _______,
                               _______, _______, _______,  _______, _______,  _______, _______, _______
    ),
